    ...
    public function mostrarListaPokemon($buscador, $filtro) {
        ...
        if ($result2->num_rows > 0) {
            while($row = $result2->fetch_assoc()) {
                ...
                echo '<a href="agregar.php?id=' . $row["numero"] . '" class="action-btn"><img src="img/editar.png" alt="Editar" title="Editar" class="action-icon"></a>';
                echo '<a href="#" class="action-btn" onclick="confirmarEliminacion(' . $row["numero"] . ')"><img src="img/eliminar.png" alt="Borrar" title="Borrar" class="action-icon"></a>';
                echo '</div>';
